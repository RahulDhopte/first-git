...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{url('add/user/view')}}">Add User</a></li>
          </ul>
        </li>
      ...
      <li><a href="{{url('config')}}">Add Configuration</a></li>
    </ul>
    </li>
    <li class="treeview">
      ...
      <li><a href="{{url('banner')}}">Add Banner</a></li>
    </ul>
  </li>
  <li class="treeview">
      ...
      <li><a href="{{url('product')}}">Add Product</a></li>
       <li><a href="{{url('product_atrribute')}}">Add Product Attribute</a></li>
        <li><a href="{{url('list_product_attribute')}}">Product Attribute list</a></li>
    </ul>
  </li>
  <li class="treeview">
